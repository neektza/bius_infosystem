class Member < ActiveRecord::Base
  ...
  has_many :fieldworks_as_leader, :through => :fieldwork_participations, :source => 'fieldwork',
  :conditions => ["fieldwork_participations.role = ?", FieldworkParticipation::ROLE[:leader]]
  has_many :fieldworks_as_participant, :through => :fieldwork_participations, :source => 'fieldwork',
  :conditions => ["fieldwork_participations.role = ?", FieldworkParticipation::ROLE[:participants]]
